...
ROOT_DIR = os.path.abspath("/content/gdrive/My Drive/landslide")
...
class CustomConfig(Config):
    """Configuration for training on the landslide  dataset.
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            self.add_image(
                "landslide",  ## for a single class just add the name here
...
def train(model):
    ...
    # imagenet trained weights, we don't need to train too long. Also,
